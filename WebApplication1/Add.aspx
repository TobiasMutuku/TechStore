...
<head>
    ...
    <title>Add Item - TechStore</title>
...
<body>
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white active bg-gradient-primary " href="/Add">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <div class="sidenav-footer position-absolute w-100 bottom-0 ">
            <div class="mx-3">
                <a href="/Logout" class="btn bg-gradient-primary mt-4 w-100">Logout</a>
            </div>
        </div>
    </aside>
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container-fluid ">
            <form method="post" enctype="multipart/form-data" class="input-control text-start" action="/ProcessAdd">
                <div class="input-group">
                    <label value="Choose Item Image" />
                    <input required class="input" type="file" accept="image/*" name="file" />
                </div>
                <div class="input-group input-group-outline my-3">
                    <input minLength="3" required maxlength="50" placeholder="Name" name="name" type="text" class="form-control">
                </div>
                <div class="input-group input-group-outline my-3">
                    <input minLength="10" maxlength="300" required placeholder="Description" name="desc" type="text" class="form-control">
                </div>
                <div class="input-group input-group-outline my-3">
