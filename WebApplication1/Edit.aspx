    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white " href="/Database">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <%
                ...
                if (rdr.HasRows)
                {
                    ...
                    { %>
                        ...
                        <form method="post" action="/ProcessEdit?area=<%=Request.QueryString["area"] %>">
                            ...
                            <div class="card-body">
                                ...
                                <div class="input-group input-group-outline mb-3">
                                    <input hidden name="item_id" placeholder="Price" required type="text" value="<%=rdr["id"] %>" class="form-control">
                                </div>
                                <div class="input-group input-group-outline mb-3">
