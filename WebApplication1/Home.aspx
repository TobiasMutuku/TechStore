...
<head>
    ...
    <title>HomePage - TechStore</title>
...
<div class="container-fluid py-4">
            <div class="row mt-auto">
                <% 
                    if (!System.IO.File.Exists($@"{Server.MapPath("~")}xml\items.xml"))
                    {
                %>
                    <div>
                ...
                <%
                    ...
                    {
                        %>
                <asp:Xml ID="Xml1" runat="server" DocumentSource="~/xml/items.xml" TransformSource="~/xslt/items.xslt"></asp:Xml>
                <%
                    }
                %>
            </div>
