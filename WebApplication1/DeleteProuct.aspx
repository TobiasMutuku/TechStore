<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteProuct.aspx.cs" Inherits="WebApplication1.DeleteProuct"  %>
...
<%
    ...
    if(Request.Cookies["role"].ToString() == "0")
    {
    ...
    string query = $"select cart.id as cart_id , cart.item_id, cart.user_id,cart.bought,Items.Id,Items.name,Items.price,Items.description,Items.image from cart join Items on Items.id = cart.item_id where user_id = '{id}' and bought = 0";
...
<div class="container-fluid py-4">
    <div class="row">
        <%
            ...
            { %>
                ...
                <a asp-page="/Index"><button class="btn btn-primary">view Available Items</button></a>
        <%
            }
            else
            {
                while (rdr.Read())
                {
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 mb-4">
                        <div class="card z-index-2  ">
                            ...
                            <a href="/Product&area=<%=rdr["item_id"]%>">
                            <div class="card-body">
                            ...
                            <div class="card-footer btn bt-danger bg-info">
                                <a href="/Delete&area=<%=rdr["cart_id"]%>">
    ...
    {%>
        <div class="text-end">
        <form method="post">
        <button class="btn btn-primary">Checkout $: <%=cartTotal %></button>
        <input hidden value="<%=cartTotal %>" type="number" name="total"/>
        </form>
        </div>
    <% } %>
            ...
            <div class="row align-items-center justify-content-lg-between">
                ...
                <div class="col-12 col-md-6">
                    <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                        ...
                        <li class="nav-item">
                            <a href="mailto: support@GoFruity.com"  class="nav-link " >Support</a>
                        </li>
                        <li class="nav-item" >
