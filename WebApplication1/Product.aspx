<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="WebApplication1.Home"  %>
...
<%
    ...
    if (rdr.HasRows)
    {
        ...
        { %>
            ...
            <br />
            <div class="text-end">
                <form action="AddToCart.aspx" method="get"><br />
                    <button type="submit" class="btn btn-primary">Add to Cart</button>
                    <input  hidden value="<%=rdr["id"] %>" name="item_id" />
                </form>
            </div>
