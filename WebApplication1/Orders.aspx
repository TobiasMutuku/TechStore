...
userId = Request.Cookies["id"].ToString();
    ...
    string query = "select item_id,user_id,bought,Items.name,Items.price,Items.description,Items.image,users.email,users.address,users.phone,users.name as username from cart join Items on Items.id = cart.item_id join users on users.id = cart.user_id where bought = 1";
%>
                ...
                <table class="table text-left ">
                    ...
                    <tbody>
                        <%
                            ...
                            if (!rdr.HasRows)
                            { %>
                                <div class="alert alert-secondary text-white">No Orders at the moment. Try again later!.</div>
                        <%
                            }
                            else
                            {
